...
lib.ssMetadata = [
		{name:"LessonChapter3_08_atlas_1", frames: [[1282,0,620,208],[1282,420,620,108],[1282,210,620,208],[1282,530,620,108],[1904,104,132,102],[1904,0,133,102],[1831,990,175,145],[0,1188,175,144],[1831,1137,175,145],[177,1188,175,144],[0,990,1829,196],[0,722,1914,266],[1904,298,91,87],[1904,208,91,88],[0,0,1280,720]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// flash0.ai
	this.instance = new lib.CachedBmp_1623();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.CachedBmp_1621();
	this.instance.setTransform(-43.65,-36,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_1622();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.CachedBmp_1619();
	this.instance.setTransform(-43.65,-36,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_271 = function() {
		...
		function fl_ClickToGoToWebPage() {
			...
			setTimeout(function(){
			document.location.replace("http://127.0.0.1:8090/LessonChapter3_09.html");
			}, 500);
	...
	// Subtitle
	this.instance = new lib.CachedBmp_1618();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/LessonChapter3_08_atlas_1.png?1655328265830", id:"LessonChapter3_08_atlas_1"},
		{src:"sounds/AfterWar209wav.mp3?1655328266024", id:"AfterWar209wav"},
		{src:"sounds/popsound.mp3?1655328266024", id:"popsound"}
	],
	preloads: []
};
