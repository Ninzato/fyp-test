...
lib.ssMetadata = [
		...
		{name:"LessonChapter1_02_atlas_2", frames: [[1497,434,249,249],[1748,434,249,249],[1045,728,133,102],[1045,832,133,102],[996,0,228,432],[230,319,331,292],[1226,0,228,432],[563,319,331,292],[0,0,330,317],[1456,0,228,432],[230,613,317,265],[332,0,330,317],[1686,0,228,432],[664,0,330,317],[0,319,228,432],[549,613,317,265],[896,434,327,292],[0,753,175,145],[1225,706,175,144],[1497,685,175,145],[868,728,175,144],[1402,796,91,87],[1402,706,91,88],[1225,434,270,270]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance_128.setTransform(192.6,121.55,0.4446,0.4446,0,74.64,-105.3595,33,9.6);

	this.instance_129 = new lib.ch1_hand_rcopy_2("synched",0);
	this.instance_129.setTransform(180.9,184.3,0.4443,0.4443,0,131.1069,-48.8944,14.3,-1.2);

	this.instance_130 = new lib.ch1_thumb_rcopy_2("synched",0);
	this.instance_130.setTransform(180.8,184.4,0.4445,0.4445,0,110.46,-69.5432,4.1,-9.8);

	this.instance_131 = new lib.ch1_lArm_rcopy_2("synched",0);
	this.instance_131.setTransform(202.25,152.3,0.4445,0.4445,0,128.9046,-51.0978,44.7,7.2);

	this.instance_132 = new lib.ch1_headcopy("synched",0);
	this.instance_132.setTransform(165.6,93.55,0.4448,0.4448,0,11.8534,-168.1462,1.6,50.5);

	this.instance_133 = new lib.ch1_uBodycopy_2("synched",0);
	this.instance_133.setTransform(169.45,113.65,0.4456,0.4456,0,0,180,-0.6,-39.1);

	this.instance_134 = new lib.ch1_uLeg_lcopy_2("synched",0);
	this.instance_134.setTransform(155.5,169.05,0.4433,0.4433,0,8.964,-171.0357,-0.8,5);

	this.instance_135 = new lib.ch1_uLeg_rcopy_2("synched",0);
	this.instance_135.setTransform(179.7,169.85,0.4437,0.4437,0,-3.9261,176.0737,0.8,-42);

	this.instance_136 = new lib.ch1_lLeg_rcopy_2("synched",0);
	this.instance_136.setTransform(184.95,212.6,0.4435,0.4435,0,-2.5534,177.4465,0.1,-50.8);

	this.instance_137 = new lib.ch1_neckcopy_2("synched",0);
	this.instance_137.setTransform(168.05,103.2,0.4449,0.4449,0,-11.3427,168.6573,-1.9,7.5);

	this.instance_138 = new lib.ch1_lLeg_lcopy_2("synched",0);
	this.instance_138.setTransform(151.15,212.4,0.4434,0.4434,0,4.2487,-175.751,2.8,-50.6);

	this.instance_139 = new lib.ch1_hand_lcopy_2("synched",0);
	this.instance_139.setTransform(129,189.7,0.4444,0.4444,0,-55.1313,124.8649,-10.2,11.6);

	this.instance_140 = new lib.ch1_thumb_lcopy_2("synched",0);
	this.instance_140.setTransform(129.25,188,0.4444,0.4444,0,-65.9213,114.0779,-7.7,14.2);

	this.instance_141 = new lib.ch1_lArm_lcopy_2("synched",0);
	this.instance_141.setTransform(141.9,151.9,0.4445,0.4445,0,-76.197,103.8044,-45,13.3);

	this.instance_142 = new lib.ch1_uArm_lcopy_2("synched",0);
	this.instance_142.setTransform(144.9,120.25,0.4446,0.4446,0,-85.4828,94.5171,-32.6,14.3);

	this.instance_143 = new lib.ch1_lBodycopy_2("synched",0);
	this.instance_143.setTransform(170.35,151.6,0.4454,0.4454,0,-1.7648,178.2352,-4.5,-21.3);
	...
	this.instance_240.setTransform(-112.15,84.2,0.4446,0.4446,0,74.64,-105.3595,33.8,10);

	this.instance_241 = new lib.ch1_hand_rcopy_2("synched",0);
	this.instance_241.setTransform(-123.8,147,0.4443,0.4443,0,131.1069,-48.8944,14.3,-0.4);

	this.instance_242 = new lib.ch1_thumb_rcopy_2("synched",0);
	this.instance_242.setTransform(-123.95,147.1,0.4445,0.4445,0,110.46,-69.5432,4.2,-9.1);

	this.instance_243 = new lib.ch1_lArm_rcopy_2("synched",0);
	this.instance_243.setTransform(-102.45,115,0.4445,0.4445,0,128.9046,-51.0978,44.4,7.6);

	this.instance_244 = new lib.ch1_headcopy("synched",0);
	this.instance_244.setTransform(-139.05,56.25,0.4448,0.4448,0,11.8534,-168.1462,2.1,50.6);

	this.instance_245 = new lib.ch1_uBodycopy_2("synched",0);
	this.instance_245.setTransform(-135.25,76.3,0.4456,0.4456,0,0,180,0,-39.7);

	this.instance_246 = new lib.ch1_uLeg_lcopy_2("synched",0);
	this.instance_246.setTransform(-149.2,131.7,0.4433,0.4433,0,8.964,-171.0357,-0.1,4.5);

	this.instance_247 = new lib.ch1_uLeg_rcopy_2("synched",0);
	this.instance_247.setTransform(-125,132.6,0.4437,0.4437,0,-3.9261,176.0737,1.4,-42.5);

	this.instance_248 = new lib.ch1_lLeg_rcopy_2("synched",0);
	this.instance_248.setTransform(-119.75,175.3,0.4435,0.4435,0,-2.5534,177.4465,0.7,-50.8);

	this.instance_249 = new lib.ch1_neckcopy_2("synched",0);
	this.instance_249.setTransform(-136.65,65.95,0.4449,0.4449,0,-11.3427,168.6573,-1.4,7.4);

	this.instance_250 = new lib.ch1_lLeg_lcopy_2("synched",0);
	this.instance_250.setTransform(-153.5,175.15,0.4434,0.4434,0,4.2487,-175.751,3.3,-50.5);

	this.instance_251 = new lib.ch1_hand_lcopy_2("synched",0);
	this.instance_251.setTransform(-175.75,152.4,0.4444,0.4444,0,-55.1313,124.8649,-10.3,10.8);

	this.instance_252 = new lib.ch1_thumb_lcopy_2("synched",0);
	this.instance_252.setTransform(-175.4,150.7,0.4444,0.4444,0,-65.9213,114.0779,-8,13.5);

	this.instance_253 = new lib.ch1_lArm_lcopy_2("synched",0);
	this.instance_253.setTransform(-162.8,114.6,0.4445,0.4445,0,-76.197,103.8044,-45.4,12.6);

	this.instance_254 = new lib.ch1_uArm_lcopy_2("synched",0);
	this.instance_254.setTransform(-159.8,82.95,0.4446,0.4446,0,-85.4828,94.5171,-32.9,13.8);

	this.instance_255 = new lib.ch1_lBodycopy_2("synched",0);
	this.instance_255.setTransform(-134.35,114.3,0.4454,0.4454,0,-1.7648,178.2352,-3.9,-21.7);
	...
	this.instance_512.setTransform(359.8,-130.7,0.4446,0.4446,0,74.64,-105.3595,33.7,9.8);

	this.instance_513 = new lib.ch1_hand_rcopy_2("synched",0);
	this.instance_513.setTransform(348.05,-67.9,0.4443,0.4443,0,131.1069,-48.8944,14.4,-0.4);

	this.instance_514 = new lib.ch1_thumb_rcopy_2("synched",0);
	this.instance_514.setTransform(348,-67.8,0.4445,0.4445,0,110.46,-69.5432,4.5,-9.1);

	this.instance_515 = new lib.ch1_lArm_rcopy_2("synched",0);
	this.instance_515.setTransform(369.45,-99.9,0.4445,0.4445,0,128.9046,-51.0978,44.4,7.6);

	this.instance_516 = new lib.ch1_headcopy("synched",0);
	this.instance_516.setTransform(332.85,-158.6,0.4448,0.4448,0,11.8534,-168.1462,2.1,50.6);

	this.instance_517 = new lib.ch1_uBodycopy_2("synched",0);
	this.instance_517.setTransform(336.7,-138.6,0.4456,0.4456,0,0,180,-0.4,-39.7);

	this.instance_518 = new lib.ch1_uLeg_lcopy_2("synched",0);
	this.instance_518.setTransform(322.7,-83.2,0.4433,0.4433,0,8.964,-171.0357,-0.1,4.5);

	this.instance_519 = new lib.ch1_uLeg_rcopy_2("synched",0);
	this.instance_519.setTransform(346.9,-82.3,0.4437,0.4437,0,-3.9261,176.0737,1.4,-42.5);

	this.instance_520 = new lib.ch1_lLeg_rcopy_2("synched",0);
	this.instance_520.setTransform(352.15,-39.6,0.4435,0.4435,0,-2.5534,177.4465,0.5,-51);

	this.instance_521 = new lib.ch1_neckcopy_2("synched",0);
	this.instance_521.setTransform(335.25,-148.95,0.4449,0.4449,0,-11.3427,168.6573,-1.4,7.4);

	this.instance_522 = new lib.ch1_lLeg_lcopy_2("synched",0);
	this.instance_522.setTransform(318.4,-39.75,0.4434,0.4434,0,4.2487,-175.751,3.3,-50.5);

	this.instance_523 = new lib.ch1_hand_lcopy_2("synched",0);
	this.instance_523.setTransform(296.15,-62.55,0.4444,0.4444,0,-55.1313,124.8649,-10.5,11);

	this.instance_524 = new lib.ch1_thumb_lcopy_2("synched",0);
	this.instance_524.setTransform(296.45,-64.2,0.4444,0.4444,0,-65.9213,114.0779,-8,13.6);

	this.instance_525 = new lib.ch1_lArm_lcopy_2("synched",0);
	this.instance_525.setTransform(309.1,-100.35,0.4445,0.4445,0,-76.197,103.8044,-45.5,12.9);

	this.instance_526 = new lib.ch1_uArm_lcopy_2("synched",0);
	this.instance_526.setTransform(312.1,-131.95,0.4446,0.4446,0,-85.4828,94.5171,-32.9,13.8);

	this.instance_527 = new lib.ch1_lBodycopy_2("synched",0);
	this.instance_527.setTransform(337.6,-100.6,0.4454,0.4454,0,-1.7648,178.2352,-4,-21.9);

	this.instance_528 = new lib.ch1_uArm_rcopy_2("synched",0);
	this.instance_528.setTransform(223.05,-52.05,0.4446,0.4446,0,74.64,-105.3595,33.6,9.5);

	this.instance_529 = new lib.ch1_hand_rcopy_2("synched",0);
	this.instance_529.setTransform(211.35,10.75,0.4443,0.4443,0,131.1069,-48.8944,14.3,-1.2);

	this.instance_530 = new lib.ch1_thumb_rcopy_2("synched",0);
	this.instance_530.setTransform(211.25,10.85,0.4445,0.4445,0,110.46,-69.5432,4.1,-9.8);

	this.instance_531 = new lib.ch1_lArm_rcopy_2("synched",0);
	this.instance_531.setTransform(232.7,-21.25,0.4445,0.4445,0,128.9046,-51.0978,44.7,7.2);

	this.instance_532 = new lib.ch1_headcopy("synched",0);
	this.instance_532.setTransform(196.05,-80,0.4448,0.4448,0,11.8534,-168.1462,1.6,50.4);

	this.instance_533 = new lib.ch1_uBodycopy_2("synched",0);
	this.instance_533.setTransform(199.9,-59.95,0.4456,0.4456,0,0,180,-0.6,-39.7);

	this.instance_534 = new lib.ch1_uLeg_lcopy_2("synched",0);
	this.instance_534.setTransform(185.95,-4.5,0.4433,0.4433,0,8.964,-171.0357,-0.7,4.5);

	this.instance_535 = new lib.ch1_uLeg_rcopy_2("synched",0);
	this.instance_535.setTransform(210.2,-3.7,0.4437,0.4437,0,-3.9261,176.0737,0.8,-41.9);

	this.instance_536 = new lib.ch1_lLeg_rcopy_2("synched",0);
	this.instance_536.setTransform(215.4,39,0.4435,0.4435,0,-2.5534,177.4465,0.1,-50.5);

	this.instance_537 = new lib.ch1_neckcopy_2("synched",0);
	this.instance_537.setTransform(198.5,-70.35,0.4449,0.4449,0,-11.3427,168.6573,-1.9,7.5);

	this.instance_538 = new lib.ch1_lLeg_lcopy_2("synched",0);
	this.instance_538.setTransform(181.65,38.9,0.4434,0.4434,0,4.2487,-175.751,2.7,-50);

	this.instance_539 = new lib.ch1_hand_lcopy_2("synched",0);
	this.instance_539.setTransform(159.45,16.15,0.4444,0.4444,0,-55.1313,124.8649,-10.2,11.6);

	this.instance_540 = new lib.ch1_thumb_lcopy_2("synched",0);
	this.instance_540.setTransform(159.7,14.45,0.4444,0.4444,0,-65.9213,114.0779,-7.7,14.2);

	this.instance_541 = new lib.ch1_lArm_lcopy_2("synched",0);
	this.instance_541.setTransform(172.4,-21.65,0.4445,0.4445,0,-76.197,103.8044,-45.5,13.2);

	this.instance_542 = new lib.ch1_uArm_lcopy_2("synched",0);
	this.instance_542.setTransform(175.35,-53.35,0.4446,0.4446,0,-85.4828,94.5171,-33,14.3);

	this.instance_543 = new lib.ch1_lBodycopy_2("synched",0);
	this.instance_543.setTransform(200.8,-21.95,0.4454,0.4454,0,-1.7648,178.2352,-4.5,-21.9);

	this.instance_544 = new lib.ch1_uArm_rcopy_2("synched",0);
	this.instance_544.setTransform(-122.6,-184.85,0.4446,0.4446,0,74.64,-105.3595,33.8,10);

	this.instance_545 = new lib.ch1_hand_rcopy_2("synched",0);
	this.instance_545.setTransform(-134.25,-122.05,0.4443,0.4443,0,131.1069,-48.8944,14.3,-0.4);

	this.instance_546 = new lib.ch1_thumb_rcopy_2("synched",0);
	this.instance_546.setTransform(-134.35,-121.95,0.4445,0.4445,0,110.46,-69.5432,4.5,-9.1);

	this.instance_547 = new lib.ch1_lArm_rcopy_2("synched",0);
	this.instance_547.setTransform(-112.9,-154.05,0.4445,0.4445,0,128.9046,-51.0978,44.4,7.6);

	this.instance_548 = new lib.ch1_headcopy("synched",0);
	this.instance_548.setTransform(-149.5,-212.75,0.4448,0.4448,0,11.8534,-168.1462,2.1,50.6);

	this.instance_549 = new lib.ch1_uBodycopy_2("synched",0);
	this.instance_549.setTransform(-145.7,-192.75,0.4456,0.4456,0,0,180,0,-39.7);

	this.instance_550 = new lib.ch1_uLeg_lcopy_2("synched",0);
	this.instance_550.setTransform(-159.65,-137.35,0.4433,0.4433,0,8.964,-171.0357,-0.1,4.5);

	this.instance_551 = new lib.ch1_uLeg_rcopy_2("synched",0);
	this.instance_551.setTransform(-135.45,-136.45,0.4437,0.4437,0,-3.9261,176.0737,1.4,-42.5);

	this.instance_552 = new lib.ch1_lLeg_rcopy_2("synched",0);
	this.instance_552.setTransform(-130.2,-93.8,0.4435,0.4435,0,-2.5534,177.4465,0.7,-51.1);

	this.instance_553 = new lib.ch1_neckcopy_2("synched",0);
	this.instance_553.setTransform(-147.1,-203.1,0.4449,0.4449,0,-11.3427,168.6573,-1.4,7.4);

	this.instance_554 = new lib.ch1_lLeg_lcopy_2("synched",0);
	this.instance_554.setTransform(-163.95,-93.9,0.4434,0.4434,0,4.2487,-175.751,3.3,-50.5);

	this.instance_555 = new lib.ch1_hand_lcopy_2("synched",0);
	this.instance_555.setTransform(-186.2,-116.65,0.4444,0.4444,0,-55.1313,124.8649,-10.3,10.8);

	this.instance_556 = new lib.ch1_thumb_lcopy_2("synched",0);
	this.instance_556.setTransform(-185.85,-118.35,0.4444,0.4444,0,-65.9213,114.0779,-8,13.5);

	this.instance_557 = new lib.ch1_lArm_lcopy_2("synched",0);
	this.instance_557.setTransform(-173.25,-154.45,0.4445,0.4445,0,-76.197,103.8044,-45.4,12.6);

	this.instance_558 = new lib.ch1_uArm_lcopy_2("synched",0);
	this.instance_558.setTransform(-170.25,-186.1,0.4446,0.4446,0,-85.4828,94.5171,-32.9,13.8);

	this.instance_559 = new lib.ch1_lBodycopy_2("synched",0);
	this.instance_559.setTransform(-144.75,-154.75,0.4454,0.4454,0,-1.7648,178.2352,-4,-21.9);

	this.instance_560 = new lib.ch1_uArm_rcopy_2("synched",0);
	this.instance_560.setTransform(-344.5,-203.85,0.4446,0.4446,0,74.6386,-105.3608,33.8,10);

	this.instance_561 = new lib.ch1_hand_rcopy_2("synched",0);
	this.instance_561.setTransform(-356.15,-141.05,0.4444,0.4443,0,131.1071,-48.8942,14.3,-0.4);

	this.instance_562 = new lib.ch1_thumb_rcopy_2("synched",0);
	this.instance_562.setTransform(-356.25,-140.95,0.4445,0.4445,0,110.4605,-69.542,4.5,-9.1);

	this.instance_563 = new lib.ch1_lArm_rcopy_2("synched",0);
	this.instance_563.setTransform(-334.8,-173.05,0.4445,0.4445,0,128.9037,-51.0975,44.4,7.7);

	this.instance_564 = new lib.ch1_headcopy("synched",0);
	this.instance_564.setTransform(-371.4,-231.8,0.4448,0.4448,0,11.855,-168.1446,2.1,50.5);

	this.instance_565 = new lib.ch1_uBodycopy_2("synched",0);
	this.instance_565.setTransform(-367.6,-211.8,0.4456,0.4457,0,0,180,0,-39.9);

	this.instance_566 = new lib.ch1_uLeg_lcopy_2("synched",0);
	this.instance_566.setTransform(-381.55,-156.3,0.4433,0.4434,0,8.9653,-171.034,-0.1,4.5);

	this.instance_567 = new lib.ch1_uLeg_rcopy_2("synched",0);
	this.instance_567.setTransform(-357.35,-155.45,0.4437,0.4437,0,-3.928,176.0719,1.4,-42.6);

	this.instance_568 = new lib.ch1_lLeg_rcopy_2("synched",0);
	this.instance_568.setTransform(-352.1,-112.8,0.4435,0.4436,0,-2.5552,177.4446,0.7,-51.1);

	this.instance_569 = new lib.ch1_neckcopy_2("synched",0);
	this.instance_569.setTransform(-369,-222.2,0.4449,0.4449,0,-11.3442,168.6558,-1.4,7.2);

	this.instance_570 = new lib.ch1_lLeg_lcopy_2("synched",0);
	this.instance_570.setTransform(-385.85,-112.9,0.4434,0.4435,0,4.2505,-175.7493,3.3,-50.6);

	this.instance_571 = new lib.ch1_hand_lcopy_2("synched",0);
	this.instance_571.setTransform(-408.1,-135.75,0.4444,0.4444,0,-55.1319,124.8654,-10.5,10.7);

	this.instance_572 = new lib.ch1_thumb_lcopy_2("synched",0);
	this.instance_572.setTransform(-407.75,-137.35,0.4444,0.4444,0,-65.9203,114.0789,-8,13.5);

	this.instance_573 = new lib.ch1_lArm_lcopy_2("synched",0);
	this.instance_573.setTransform(-395.1,-173.45,0.4445,0.4445,0,-76.1956,103.8078,-45.5,12.6);

	this.instance_574 = new lib.ch1_uArm_lcopy_2("synched",0);
	this.instance_574.setTransform(-392.15,-205.15,0.4447,0.4446,0,-85.481,94.5189,-33,13.8);

	this.instance_575 = new lib.ch1_lBodycopy_2("synched",0);
	this.instance_575.setTransform(-366.65,-173.75,0.4454,0.4454,0,-1.7667,178.2333,-4,-21.9);
...
p.nominalBounds = new cjs.Rectangle(-470.2,-314.4,883.0999999999999,764.7);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/LessonChapter1_02_atlas_1.png?1655309303799", id:"LessonChapter1_02_atlas_1"},
		{src:"images/LessonChapter1_02_atlas_2.png?1655309303800", id:"LessonChapter1_02_atlas_2"},
		{src:"sounds/beforewar2edit_02wav.mp3?1655309304428", id:"beforewar2edit_02wav"}
	],
	preloads: []
};
