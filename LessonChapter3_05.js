...
lib.ssMetadata = [
		{name:"LessonChapter3_05_atlas_1", frames: [[1282,0,580,592],[0,1188,569,546],[1282,594,132,102],[1864,586,133,102],[1864,0,175,145],[1864,294,175,144],[1864,147,175,145],[1864,440,175,144],[0,990,1829,196],[0,722,1914,266],[1509,594,91,87],[1416,594,91,88],[0,0,1280,720]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.CachedBmp_1540();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.CachedBmp_1539();
	this.instance.setTransform(0,0,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1 = new lib.CachedBmp_1538();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.CachedBmp_1533();
	this.instance.setTransform(-43.65,-36,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_1534();
...
if (reversed == null) { reversed = false; }
	...
	// Subtitle
	this.instance = new lib.CachedBmp_1532();
	this.instance.setTransform(182.8,581,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_1531();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/LessonChapter3_05_atlas_1.png?1655327853576", id:"LessonChapter3_05_atlas_1"},
		{src:"sounds/AfterWar205wav.mp3?1655327853670", id:"AfterWar205wav"},
		{src:"sounds/popsound.mp3?1655327853670", id:"popsound"}
	],
	preloads: []
};
