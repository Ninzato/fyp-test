...
lib.ssMetadata = [
		{name:"Quiz_06_atlas_1", frames: [[1916,0,132,102],[1743,854,133,102],[0,398,579,258],[581,398,579,258],[1162,398,579,258],[581,918,503,224],[0,658,579,258],[581,658,579,258],[1162,658,579,258],[1086,918,503,224],[0,918,579,258],[581,1144,503,224],[1781,268,175,145],[1743,562,175,144],[1743,415,175,145],[1743,708,175,144],[1684,918,20,128],[0,268,1779,128],[0,0,1914,266],[1591,918,91,87],[1916,104,91,88]]}
];
...
(lib.CachedBmp_140 = function() {
	this.initialize(ss["Quiz_06_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.false2 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(-125.8,-56,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_136();
	this.instance_1.setTransform(-144.75,-64.45,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_137();
	this.instance_2.setTransform(-144.75,-64.45,0.5,0.5);

	this.instance_3 = new lib.CachedBmp_138();
	this.instance_3.setTransform(-144.75,-64.45,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-144.7,-64.4,289.5,129);
...
// stage content:
(lib.Quiz_06 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// question
	this.instance = new lib.false2();
	this.instance.setTransform(936.55,445.8);
	new cjs.ButtonHelper(this.instance, 0, 1, 2, false, new lib.false2(), 3);

	this.instance_1 = new lib._false();
	this.instance_1.setTransform(343.45,445.8);
	new cjs.ButtonHelper(this.instance_1, 0, 1, 2, false, new lib._false(), 3);

	this.instance_2 = new lib.correct();
	this.instance_2.setTransform(640,445.8);
	new cjs.ButtonHelper(this.instance_2, 0, 1, 1);

	this.instance_3 = new lib.CachedBmp_124();
	this.instance_3.setTransform(939.75,549.05,0.5,0.5);

	this.instance_4 = new lib.CachedBmp_123();
	this.instance_4.setTransform(195.55,203.05,0.5,0.5);

	this.instance_5 = new lib.CachedBmp_122();
	this.instance_5.setTransform(165.6,171,0.5,0.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Quiz_06_atlas_1.png?1654964464126", id:"Quiz_06_atlas_1"}
	],
	preloads: []
};
