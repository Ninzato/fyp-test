...
lib.ssMetadata = [
		{name:"LessonChapter2_04_atlas_1", frames: [[0,1548,474,240],[0,1790,474,240],[476,1548,474,240],[1631,1548,330,308],[952,1548,357,308],[1311,1548,318,333],[0,1350,1779,196],[0,1082,1914,266],[0,0,1920,1080]]},
		{name:"LessonChapter2_04_atlas_2", frames: [[744,548,132,102],[829,146,133,102],[320,312,434,84],[320,398,434,84],[0,604,434,155],[0,310,318,292],[0,0,330,308],[826,652,193,36],[826,690,193,36],[332,0,318,310],[631,691,193,36],[826,728,193,36],[652,0,175,145],[756,294,175,144],[652,147,175,145],[829,0,175,144],[436,592,193,69],[320,484,210,106],[631,652,193,37],[756,440,210,106],[436,663,193,37],[532,484,210,106],[933,340,91,87],[933,250,91,88]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-76.3,-81.5,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_289 = function() {
		...
		function fl_ClickToGoToWebPage_2() {
			document.location.replace("http://127.0.0.1:8090/LessonChapter2_03.html");
		}
	...
	this.instance_3.setTransform(698.1,220.55,0.5,0.5);

	this.instance_4 = new lib.ch1_uArm_rcopy("synched",0);
	this.instance_4.setTransform(773.1,376.4,0.4433,0.4433,0,90.7594,-89.2406,35.6,0.2);

	this.instance_5 = new lib.ch1_hand_rcopy("synched",0);
	this.instance_5.setTransform(742.9,437.5,0.4431,0.4431,0,148.1473,-31.8527,6.2,-1.7);

	this.instance_6 = new lib.ch1_thumb_rcopy("synched",0);
	this.instance_6.setTransform(744.45,433.85,0.4432,0.4432,0,124.8046,-55.1954,5.4,-8.7);

	this.instance_7 = new lib.ch1_lArm_rcopy("synched",0);
	this.instance_7.setTransform(772,411.5,0.4432,0.4432,0,141.5716,-38.4284,39.8,0.7);

	this.instance_8 = new lib.ch1_headcopy("synched",0);
	this.instance_8.setTransform(747.7,351.6,0.4435,0.4435,0,3.6474,-176.3526,0.6,52.9);

	this.instance_9 = new lib.ch1_uBodycopy("synched",0);
	this.instance_9.setTransform(751.05,377.6,0.4439,0.4439,0,0,180,-0.2,-23.8);

	this.instance_10 = new lib.ch1_lLeg_rcopy("synched",0);
	this.instance_10.setTransform(758.35,470.65,0.4431,0.4431,0,-16.8002,163.1998,2.7,-54.3);

	this.instance_11 = new lib.ch1_neckcopy("synched",0);
	this.instance_11.setTransform(749.85,360.85,0.4435,0.4435,0,-12.1091,167.8909,-0.8,8.8);

	this.instance_12 = new lib.ch1_lBodycopy("synched",0);
	this.instance_12.setTransform(750.3,407.95,0.4439,0.4439,0,0,180,-0.4,-23.1);

	this.instance_13 = new lib.ch1_lLeg_lcopy("synched",0);
	this.instance_13.setTransform(734.9,470.7,0.443,0.443,0,11.5933,-168.4067,2.4,-53.6);

	this.instance_14 = new lib.ch1_uLeg_lcopy("synched",0);
	this.instance_14.setTransform(743.5,428.95,0.443,0.443,0,14.7174,-165.2826,-1.1,2);

	this.instance_15 = new lib.ch1_hand_lcopy("synched",0);
	this.instance_15.setTransform(726.85,439.25,0.4432,0.4432,0,-58.7152,121.2848,-5,3.3);

	this.instance_16 = new lib.ch1_thumb_lcopy("synched",0);
	this.instance_16.setTransform(724.75,434.85,0.4433,0.4433,0,-96.3879,83.6121,-6,8);

	this.instance_17 = new lib.ch1_lArm_lcopy("synched",0);
	this.instance_17.setTransform(743.85,404.65,0.4432,0.4432,0,-58.0417,121.9583,-40.6,-0.5);

	this.instance_18 = new lib.ch1_uArm_lcopy("synched",0);
	this.instance_18.setTransform(727.75,374.95,0.4432,0.4432,0,-119.3115,60.6885,-33.6,-0.1);

	this.instance_19 = new lib.ch1_uLeg_rcopy("synched",0);
	this.instance_19.setTransform(755.35,427.85,0.4432,0.4432,0,-1.8465,178.1535,2,-45.9);

	this.instance_20 = new lib.CachedBmp_58();
	this.instance_20.setTransform(834.4,237.8,0.5,0.5);

	this.instance_21 = new lib.CachedBmp_57();
	this.instance_21.setTransform(830,220.6,0.5,0.5);

	this.instance_22 = new lib.ch1_uArm_rcopy2_1("synched",0);
	this.instance_22.setTransform(908.35,377.3,0.4432,0.4432,0,88.8834,-91.1166,35.9,0.2);

	this.instance_23 = new lib.ch1_hand_rcopy2_1("synched",0);
	this.instance_23.setTransform(879.35,439.1,0.443,0.443,0,155.4695,-24.5305,6.2,-1.7);

	this.instance_24 = new lib.ch1_thumb_rcopy2_1("synched",0);
	this.instance_24.setTransform(880.9,435.5,0.4431,0.4431,0,122.9929,-57.0071,5,-8.8);

	this.instance_25 = new lib.ch1_lArm_rcopy2_1("synched",0);
	this.instance_25.setTransform(908.45,412.5,0.4431,0.4431,0,140.7656,-39.2344,39.9,0.8);

	this.instance_26 = new lib.ch1_headcopy2_1("synched",0);
	this.instance_26.setTransform(882.7,352.5,0.4434,0.4434,0,3.6419,-176.3581,1,52.8);

	this.instance_27 = new lib.ch1_uBodycopy2_1("synched",0);
	this.instance_27.setTransform(886.15,378.55,0.4439,0.4439,0,0,180,-0.2,-23.9);

	this.instance_28 = new lib.ch1_lLeg_rcopy2_1("synched",0);
	this.instance_28.setTransform(897.55,471.1,0.4431,0.4431,0,-12.7216,167.2784,2.9,-54);

	this.instance_29 = new lib.ch1_neckcopy2_1("synched",0);
	this.instance_29.setTransform(885.15,361.85,0.4434,0.4434,0,-12.1065,167.8935,-1,9);

	this.instance_30 = new lib.ch1_lBodycopy2_1("synched",0);
	this.instance_30.setTransform(885.45,408.95,0.4439,0.4439,0,0,180,-0.4,-23);

	this.instance_31 = new lib.ch1_lLeg_lcopy2_1("synched",0);
	this.instance_31.setTransform(867.05,470.7,0.4429,0.4429,0,6.8993,-173.1007,3.6,-53.6);

	this.instance_32 = new lib.ch1_uLeg_lcopy2_1("synched",0);
	this.instance_32.setTransform(876.6,429.3,0.4429,0.4429,0,15.3955,-164.6045,-0.8,2.2);

	this.instance_33 = new lib.ch1_hand_lcopy2_1("synched",0);
	this.instance_33.setTransform(874.2,449.35,0.4431,0.4431,0,-61.5931,118.4069,-4.7,3.4);

	this.instance_34 = new lib.ch1_thumb_lcopy2_1("synched",0);
	this.instance_34.setTransform(872.8,444.6,0.4431,0.4431,0,-87.9201,92.0799,-6.2,8.2);

	this.instance_35 = new lib.ch1_lArm_lcopy2_1("synched",0);
	this.instance_35.setTransform(868.35,409.4,0.4432,0.4432,0,-97.0922,82.9078,-39.7,-1);

	this.instance_36 = new lib.ch1_uArm_lcopy2_1("synched",0);
	this.instance_36.setTransform(862.85,376.05,0.4432,0.4432,0,-100.1256,79.8744,-33,-0.3);

	this.instance_37 = new lib.ch1_uLeg_rcopy2_1("synched",0);
	this.instance_37.setTransform(891.95,428.2,0.4432,0.4432,0,-5.2469,174.7531,2.2,-46.2);

	this.instance_38 = new lib.CachedBmp_56();
	this.instance_38.setTransform(962.05,237.75,0.5,0.5);

	this.instance_39 = new lib.CachedBmp_55();
	this.instance_39.setTransform(957.65,220.55,0.5,0.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/LessonChapter2_04_atlas_1.png?1655215271823", id:"LessonChapter2_04_atlas_1"},
		{src:"images/LessonChapter2_04_atlas_2.png?1655215271824", id:"LessonChapter2_04_atlas_2"},
		{src:"sounds/DuringWar204wav.mp3?1655215272116", id:"DuringWar204wav"}
	],
	preloads: []
};
