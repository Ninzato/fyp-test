...
lib.ssMetadata = [
		{name:"LessonChapter1_08_atlas_1", frames: [[1927,961,88,153],[950,754,68,165],[1916,0,84,202],[620,754,271,266],[651,1144,195,58],[0,1015,277,140],[1389,1156,166,50],[279,1031,235,119],[1802,1136,133,102],[516,1144,133,102],[333,721,285,308],[1366,721,304,286],[1033,402,330,317],[1781,268,228,432],[0,721,331,292],[1697,402,55,257],[1927,702,55,257],[1984,702,55,256],[893,754,55,256],[1646,1136,154,132],[628,402,403,350],[1469,1009,175,145],[1035,1128,175,144],[858,1128,175,145],[1212,1128,175,144],[0,402,626,317],[893,1015,574,111],[279,1152,217,42],[620,1022,236,120],[1365,402,330,317],[1697,702,228,432],[1033,721,331,292],[0,268,1779,132],[0,0,1914,266],[1937,1116,91,87],[516,1031,91,88]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-43.55,-98.25,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_529();
	this.instance_1.setTransform(-60.9,-115.6,0.5,0.5);

	this.instance_2 = new lib.camel_leg_b_l_bcopy("synched",0);
	this.instance_2.setTransform(24.65,69.5,0.5162,0.5161,-14.0699,0,0,8,-45.1);

	this.instance_3 = new lib.camel_leg_f_l_bcopy("synched",0);
	this.instance_3.setTransform(-21.3,73.4,0.5168,0.5167,33.3034,0,0,12.1,-44.1);

	this.instance_4 = new lib.camel_leg_b_l_ucopy("synched",0);
	this.instance_4.setTransform(21.3,37.8,0.5166,0.5165,-13.1113,0,0,3.5,-26.4);

	this.instance_5 = new lib.camel_leg_f_l_ucopy("synched",0);
	this.instance_5.setTransform(-6.45,46.85,0.5169,0.5169,28.2242,0,0,1.1,-26.1);

	this.instance_6 = new lib.camel_headcopy("synched",0);
	this.instance_6.setTransform(-36.25,6.4,0.5169,0.5168,1.6395,0,0,22.1,17.2);

	this.instance_7 = new lib.camel_neckcopy("synched",0);
	this.instance_7.setTransform(-26.15,25.25,0.5167,0.5167,19.9874,0,0,33.8,15.7);

	this.instance_8 = new lib.camel_bodycopy("synched",0);
	this.instance_8.setTransform(-9.8,27.2,0.518,0.5179,0,0,0,0.1,0.8);

	this.instance_9 = new lib.camel_leg_f_r_bcopy("synched",0);
	this.instance_9.setTransform(-23.3,67,0.517,0.5169,-26.7973,0,0,-5.6,-52.2);

	this.instance_10 = new lib.camel_leg_f_r_ucopy("synched",0);
	this.instance_10.setTransform(-33.45,38.25,0.5171,0.517,-19.5928,0,0,-15.8,-33.6);

	this.instance_11 = new lib.camel_leg_b_r_bcopy("synched",0);
	this.instance_11.setTransform(15.35,64.1,0.5164,0.5162,-11.5275,0,0,5.6,-39.1);

	this.instance_12 = new lib.camel_leg_b_r_ucopy("synched",0);
	this.instance_12.setTransform(9.95,29.25,0.5161,0.516,-15.7834,0,0,2.6,-27.9);

	this.instance_13 = new lib.camel_tailcopy("synched",0);
	this.instance_13.setTransform(19.9,28.25,0.5167,0.5167,-45.2536,0,0,-14.3,-30.9);
...
p.nominalBounds = new cjs.Rectangle(-61.4,-115.6,118,213.89999999999998);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-52.35,-85.35,0.5,0.5);
	...
	this.instance_2.setTransform(28.5,34.55,0.2169,0.2169,-92.617,0,0,31.9,9.6);

	this.instance_3 = new lib.ch1_hand_rcopy2("synched",0);
	this.instance_3.setTransform(42.05,63.25,0.2167,0.2167,-132.2037,0,0,12.8,0.4);

	this.instance_4 = new lib.ch1_thumb_rcopy2("synched",0);
	this.instance_4.setTransform(42.15,63.25,0.2169,0.2169,-102.3884,0,0,3.6,-7.5);

	this.instance_5 = new lib.ch1_lArm_rcopy2("synched",0);
	this.instance_5.setTransform(28.8,50,0.2168,0.2168,-140.2202,0,0,43.8,7.1);

	this.instance_6 = new lib.ch1_headcopy3("synched",0);
	this.instance_6.setTransform(41.8,19.5,0.217,0.217,-11.833,0,0,3.5,52.1);

	this.instance_7 = new lib.ch1_uBodycopy2_1("synched",0);
	this.instance_7.setTransform(39.9,29.4,0.2175,0.2175,0,0,0,1.6,-38);

	this.instance_8 = new lib.ch1_uLeg_lcopy2("synched",0);
	this.instance_8.setTransform(46.85,56.35,0.2163,0.2163,-8.9419,0,0,2,6.2);

	this.instance_9 = new lib.ch1_uLeg_rcopy2("synched",0);
	this.instance_9.setTransform(34.9,56.6,0.2164,0.2164,3.8971,0,0,1.6,-41.4);

	this.instance_10 = new lib.ch1_lLeg_rcopy2("synched",0);
	this.instance_10.setTransform(32.45,77.65,0.2163,0.2163,8.7102,0,0,2,-49.4);

	this.instance_11 = new lib.ch1_neckcopy2("synched",0);
	this.instance_11.setTransform(40.65,24,0.217,0.217,11.3297,0,0,0.7,6.9);

	this.instance_12 = new lib.ch1_lLeg_lcopy2("synched",0);
	this.instance_12.setTransform(48.85,77.7,0.2163,0.2163,-14.5353,0,0,4.4,-48.3);

	this.instance_13 = new lib.ch1_hand_lcopy2("synched",0);
	this.instance_13.setTransform(53.8,65.25,0.2168,0.2168,124.99,0,0,-10.6,9.1);

	this.instance_14 = new lib.ch1_thumb_lcopy2("synched",0);
	this.instance_14.setTransform(54.45,65.25,0.2168,0.2168,150.2121,0,0,-8.1,11.8);

	this.instance_15 = new lib.ch1_lArm_lcopy2("synched",0);
	this.instance_15.setTransform(48.2,47.7,0.2168,0.2168,76.0166,0,0,-43,11.4);

	this.instance_16 = new lib.ch1_uArm_lcopy2("synched",0);
	this.instance_16.setTransform(51.9,32.7,0.2169,0.2169,104.8751,0,0,-31.7,11.1);

	this.instance_17 = new lib.ch1_lBodycopy2("synched",0);
	this.instance_17.setTransform(39.25,47.9,0.2173,0.2173,1.7463,0,0,-3.6,-20.2);

	this.instance_18 = new lib.camel_leg_b_l_b("synched",0);
	this.instance_18.setTransform(-41.9,46.65,0.5523,0.5523,0,-4.4669,175.5331,5.5,-37.4);

	this.instance_19 = new lib.camel_leg_f_l_b("synched",0);
	this.instance_19.setTransform(-1.85,57.55,0.553,0.553,0,-7.1105,172.8895,3.9,-38);

	this.instance_20 = new lib.camel_leg_b_l_u("synched",0);
	this.instance_20.setTransform(-39.35,9.5,0.5527,0.5527,0,11.9329,-168.0671,2.6,-27.2);

	this.instance_21 = new lib.camel_leg_f_l_u("synched",0);
	this.instance_21.setTransform(-9.95,23.25,0.5531,0.5531,0,-6.6635,173.3365,-0.1,-24.6);

	this.instance_22 = new lib.camel_head("synched",0);
	this.instance_22.setTransform(25.8,-16.15,0.5529,0.5529,0,11.7478,-168.2522,12.2,11.2);

	this.instance_23 = new lib.camel_neck("synched",0);
	this.instance_23.setTransform(22.45,2.5,0.5529,0.5529,0,-19.9773,160.0227,9.1,12.7);

	this.instance_24 = new lib.camel_body("synched",0);
	this.instance_24.setTransform(-7.3,1.4,0.5535,0.5535,0,0,180,0.8,0.6);

	this.instance_25 = new lib.camel_leg_f_r_b("synched",0);
	this.instance_25.setTransform(-2.75,51.15,0.5531,0.5531,0,24.9657,-155.0343,3.8,-37.1);

	this.instance_26 = new lib.camel_leg_f_r_u("synched",0);
	this.instance_26.setTransform(10,15.95,0.5532,0.5532,0,24.7441,-155.2559,-1.4,-27.6);

	this.instance_27 = new lib.camel_tail("synched",0);
	this.instance_27.setTransform(-40.55,0.65,0.5531,0.5531,0,1.9208,-178.0792,-7.6,-35.2);

	this.instance_28 = new lib.camel_leg_b_r_b("synched",0);
	this.instance_28.setTransform(-47.5,36.7,0.5524,0.5524,0,14.7099,-165.2901,5.2,-36.6);

	this.instance_29 = new lib.camel_leg_b_r_u("synched",0);
	this.instance_29.setTransform(-27.5,4.85,0.5521,0.5521,0,38.5179,-141.4821,0.5,-28.2);
...
p.nominalBounds = new cjs.Rectangle(-61,-104.7,121.6,207.8);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_169 = function() {
		...
		function fl_ClickToGoToWebPage_2() {
			document.location.replace("http://127.0.0.1:8090/LessonChapter1_07.html");
		}
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_504.png?1655309420366", id:"CachedBmp_504"},
		{src:"images/LessonChapter1_08_atlas_1.png?1655309420136", id:"LessonChapter1_08_atlas_1"},
		{src:"sounds/beforewar2edit_08wav.mp3?1655309420366", id:"beforewar2edit_08wav"}
	],
	preloads: []
};
