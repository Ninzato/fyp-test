...
lib.ssMetadata = [
		{name:"Quiz_04_atlas_1", frames: [[1916,0,132,102],[1844,708,133,102],[505,690,579,147],[1086,690,579,147],[505,839,579,147],[0,944,503,128],[0,398,579,290],[581,398,579,290],[1162,398,579,290],[0,690,503,252],[1086,839,579,147],[505,988,503,128],[1781,268,175,145],[1743,562,175,144],[1743,415,175,145],[1667,708,175,144],[2009,104,20,128],[0,268,1779,128],[0,0,1914,266],[1920,415,91,87],[1916,104,91,88]]}
];
...
(lib.CachedBmp_87 = function() {
	this.initialize(ss["Quiz_04_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-144.75,-36.8,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_84();
	this.instance_2.setTransform(-144.75,-36.8,0.5,0.5);

	this.instance_3 = new lib.CachedBmp_85();
	this.instance_3.setTransform(-144.75,-36.8,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-144.7,-36.8,289.5,73.5);
...
p.nominalBounds = new cjs.Rectangle(-144.7,-36.8,289.5,145);
...
// stage content:
(lib.Quiz_04 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Quiz_04_atlas_1.png?1654963572924", id:"Quiz_04_atlas_1"}
	],
	preloads: []
};
