...
lib.ssMetadata = [
		{name:"LessonChapter1_07_atlas_1", frames: [[1806,1718,133,102],[333,1728,133,102],[1282,0,330,317],[1781,990,228,432],[1584,1424,331,292],[1614,0,330,317],[664,1124,228,432],[0,1443,331,292],[1282,319,330,317],[894,1124,228,432],[991,1558,317,265],[1614,319,330,317],[1124,1124,228,432],[0,1124,330,317],[1354,1124,228,432],[1310,1718,317,265],[333,1434,327,292],[332,1124,330,308],[662,1558,327,292],[1584,1124,175,145],[1310,1558,175,144],[1584,1271,175,145],[1629,1718,175,144],[0,990,1779,132],[0,722,1914,266],[1946,90,91,87],[1946,0,91,88],[0,0,1280,720]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// flash0_ai
	this.instance_1 = new lib.CachedBmp_554();
...
if (reversed == null) { reversed = false; }
	...
	// flash0_ai
	this.instance_1 = new lib.CachedBmp_549();
	this.instance_1.setTransform(-56.95,-12.25,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-140.8,-212.5,356.1,509.9);
...
if (reversed == null) { reversed = false; }
	...
	// Armature_1
	this.instance = new lib.ch1_uArm_rcopy2_2("synched",0);
	this.instance.setTransform(23,-12.4,0.4424,0.4422,0,62.7815,-117.1828,35,0.2);

	this.instance_1 = new lib.ch1_hand_rcopy2_2("synched",0);
	this.instance_1.setTransform(13.85,49.55,0.4422,0.4422,0,131.368,-48.6737,6,-2);

	this.instance_2 = new lib.ch1_thumb_rcopy2_2("synched",0);
	this.instance_2.setTransform(16.65,46.7,0.4422,0.4423,0,141.6233,-38.4196,5.4,-9.8);

	this.instance_3 = new lib.ch1_lArm_rcopy2_2("synched",0);
	this.instance_3.setTransform(38.95,18.5,0.4423,0.4422,0,128.2748,-51.7677,40.1,-0.7);

	this.instance_4 = new lib.ch1_headcopy2_3("synched",0);
	this.instance_4.setTransform(-2.05,-37.45,0.4424,0.4428,0,0.78,-179.2194,0.8,52.4);

	this.instance_5 = new lib.ch1_uBodycopy2_2("synched",0);
	this.instance_5.setTransform(0.85,-11.35,0.4428,0.4432,0,0,180,-0.4,-24.2);

	this.instance_6 = new lib.ch1_lLeg_rcopy2_2("synched",0);
	this.instance_6.setTransform(15.2,80.15,0.442,0.4424,0,-0.1443,179.8556,2.6,-53.9);

	this.instance_7 = new lib.ch1_neckcopy2_2("synched",0);
	this.instance_7.setTransform(-0.25,-28.15,0.4424,0.4427,0,-9.8815,170.1056,-0.7,8.4);

	this.instance_8 = new lib.ch1_lBodycopy2_2("synched",0);
	this.instance_8.setTransform(0.05,19,0.4428,0.4432,0,0,180,-0.1,-22.7);

	this.instance_9 = new lib.ch1_lLeg_lcopy2_2("synched",0);
	this.instance_9.setTransform(-19,79.9,0.4418,0.4422,0,-10.1593,169.8275,4.2,-52.9);

	this.instance_10 = new lib.ch1_uLeg_lcopy2_2("synched",0);
	this.instance_10.setTransform(-11.35,38,0.4418,0.4421,0,12.9547,-167.0278,-0.5,2.6);

	this.instance_11 = new lib.ch1_hand_lcopy2_2("synched",0);
	this.instance_11.setTransform(-50.3,-9.5,0.4424,0.4422,0,62.5162,-117.4481,-5.1,2.9);

	this.instance_12 = new lib.ch1_thumb_lcopy2_2("synched",0);
	this.instance_12.setTransform(-46.3,-6.45,0.4424,0.4422,0,55.6317,-124.3287,-6.1,8.3);

	this.instance_13 = new lib.ch1_lArm_lcopy2_2("synched",0);
	this.instance_13.setTransform(-22.4,19.9,0.4423,0.4423,0,47.7561,-132.2007,-40.9,-0.1);

	this.instance_14 = new lib.ch1_uArm_lcopy2_2("synched",0);
	this.instance_14.setTransform(-22.6,-13.85,0.4425,0.4421,0,-91.0678,88.9331,-32.9,-0.4);

	this.instance_15 = new lib.ch1_uLeg_rcopy2_2("synched",0);
	this.instance_15.setTransform(7.5,38.35,0.442,0.4424,0,-7.8886,172.0995,2.4,-44.9);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.ch1_uArm_rcopy_2("synched",0);
	this.instance.setTransform(253.05,61.1,0.4445,0.4445,-74.6441,0,0,33.9,10.1);

	this.instance_1 = new lib.ch1_hand_rcopy_2("synched",0);
	this.instance_1.setTransform(264.65,123.95,0.4443,0.4443,-131.1063,0,0,14.3,-0.4);

	this.instance_2 = new lib.ch1_thumb_rcopy_2("synched",0);
	this.instance_2.setTransform(264.75,123.95,0.4444,0.4444,-110.4559,0,0,4.4,-9.1);

	this.instance_3 = new lib.ch1_lArm_rcopy_2("synched",0);
	this.instance_3.setTransform(243.35,91.95,0.4444,0.4444,-128.9025,0,0,44.2,7.7);

	this.instance_4 = new lib.ch1_headcopy("synched",0);
	this.instance_4.setTransform(279.9,33.15,0.4448,0.4448,-11.8508,0,0,2.1,50.4);

	this.instance_5 = new lib.ch1_uBodycopy_2("synched",0);
	this.instance_5.setTransform(276.1,53.25,0.4456,0.4456,0,0,0,0,-39.7);

	this.instance_6 = new lib.ch1_uLeg_lcopy_2("synched",0);
	this.instance_6.setTransform(290.05,108.65,0.4433,0.4433,-8.9607,0,0,-0.1,4.5);

	this.instance_7 = new lib.ch1_uLeg_rcopy_2("synched",0);
	this.instance_7.setTransform(265.85,109.55,0.4436,0.4437,3.9226,0,0,1.4,-42.5);

	this.instance_8 = new lib.ch1_lLeg_rcopy_2("synched",0);
	this.instance_8.setTransform(260.6,152.25,0.4435,0.4435,2.5497,0,0,0.7,-50.8);

	this.instance_9 = new lib.ch1_neckcopy_2("synched",0);
	this.instance_9.setTransform(277.5,42.85,0.4448,0.4448,11.34,0,0,-1.4,7.3);

	this.instance_10 = new lib.ch1_lLeg_lcopy_2("synched",0);
	this.instance_10.setTransform(294.35,152.1,0.4434,0.4434,-4.2452,0,0,3.3,-50.6);

	this.instance_11 = new lib.ch1_hand_lcopy_2("synched",0);
	this.instance_11.setTransform(316.7,129.35,0.4443,0.4443,55.1339,0,0,-10.2,10.6);

	this.instance_12 = new lib.ch1_thumb_lcopy_2("synched",0);
	this.instance_12.setTransform(316.25,127.65,0.4443,0.4443,65.9242,0,0,-8,13.5);

	this.instance_13 = new lib.ch1_lArm_lcopy_2("synched",0);
	this.instance_13.setTransform(303.65,91.55,0.4445,0.4444,76.2014,0,0,-45.4,12.6);

	this.instance_14 = new lib.ch1_uArm_lcopy_2("synched",0);
	this.instance_14.setTransform(300.65,59.85,0.4446,0.4446,85.4862,0,0,-33,13.8);

	this.instance_15 = new lib.ch1_lBodycopy_2("synched",0);
	this.instance_15.setTransform(275.2,91.25,0.4454,0.4454,1.7611,0,0,-3.9,-21.7);
	...
	this.instance_112.setTransform(-178.75,13.4,0.4445,0.4445,-74.6441,0,0,33.8,9.6);

	this.instance_113 = new lib.ch1_hand_rcopy_2("synched",0);
	this.instance_113.setTransform(-167.05,76.25,0.4443,0.4443,-131.1063,0,0,14.4,-0.9);

	this.instance_114 = new lib.ch1_thumb_rcopy_2("synched",0);
	this.instance_114.setTransform(-166.95,76.35,0.4444,0.4444,-110.4559,0,0,4.5,-9.5);

	this.instance_115 = new lib.ch1_lArm_rcopy_2("synched",0);
	this.instance_115.setTransform(-188.45,44.25,0.4444,0.4444,-128.9025,0,0,44.6,7.3);

	this.instance_116 = new lib.ch1_headcopy("synched",0);
	this.instance_116.setTransform(-151.8,-14.55,0.4448,0.4448,-11.8508,0,0,1.8,49.9);

	this.instance_117 = new lib.ch1_uBodycopy_2("synched",0);
	this.instance_117.setTransform(-155.65,5.55,0.4456,0.4456,0,0,0,-0.5,-39.7);

	this.instance_118 = new lib.ch1_uLeg_lcopy_2("synched",0);
	this.instance_118.setTransform(-141.7,61,0.4433,0.4433,-8.9607,0,0,-0.6,4.5);

	this.instance_119 = new lib.ch1_uLeg_rcopy_2("synched",0);
	this.instance_119.setTransform(-165.85,61.85,0.4436,0.4437,3.9226,0,0,1,-42.5);

	this.instance_120 = new lib.ch1_lLeg_rcopy_2("synched",0);
	this.instance_120.setTransform(-171.15,104.55,0.4435,0.4435,2.5497,0,0,0.2,-50.8);

	this.instance_121 = new lib.ch1_neckcopy_2("synched",0);
	this.instance_121.setTransform(-154.25,-4.9,0.4448,0.4448,11.34,0,0,-1.9,6.9);

	this.instance_122 = new lib.ch1_lLeg_lcopy_2("synched",0);
	this.instance_122.setTransform(-137.35,104.4,0.4434,0.4434,-4.2452,0,0,2.9,-50.6);

	this.instance_123 = new lib.ch1_hand_lcopy_2("synched",0);
	this.instance_123.setTransform(-115.05,81.6,0.4443,0.4443,55.1339,0,0,-10.5,11);

	this.instance_124 = new lib.ch1_thumb_lcopy_2("synched",0);
	this.instance_124.setTransform(-115.5,79.95,0.4443,0.4443,65.9242,0,0,-7.9,14);

	this.instance_125 = new lib.ch1_lArm_lcopy_2("synched",0);
	this.instance_125.setTransform(-128.1,43.85,0.4445,0.4444,76.2014,0,0,-45.5,13.1);

	this.instance_126 = new lib.ch1_uArm_lcopy_2("synched",0);
	this.instance_126.setTransform(-131.1,12.15,0.4446,0.4446,85.4862,0,0,-32.7,14.2);

	this.instance_127 = new lib.ch1_lBodycopy_2("synched",0);
	this.instance_127.setTransform(-156.55,43.55,0.4454,0.4454,1.7611,0,0,-4.4,-21.7);
	...
	this.instance_304.setTransform(123.75,-27.15,0.4445,0.4445,-74.6441,0,0,33.9,10.1);

	this.instance_305 = new lib.ch1_hand_rcopy_2("synched",0);
	this.instance_305.setTransform(135.35,35.7,0.4443,0.4443,-131.1063,0,0,14,-0.7);

	this.instance_306 = new lib.ch1_thumb_rcopy_2("synched",0);
	this.instance_306.setTransform(135.45,35.75,0.4444,0.4444,-110.4559,0,0,4.2,-9.2);

	this.instance_307 = new lib.ch1_lArm_rcopy_2("synched",0);
	this.instance_307.setTransform(114.05,3.7,0.4444,0.4444,-128.9025,0,0,44,7.5);

	this.instance_308 = new lib.ch1_headcopy("synched",0);
	this.instance_308.setTransform(150.6,-55.1,0.4448,0.4448,-11.8508,0,0,2.2,50);
	...
	this.instance_310.setTransform(160.75,20.45,0.4433,0.4433,-8.9607,0,0,-0.2,4.9);

	this.instance_311 = new lib.ch1_uLeg_rcopy_2("synched",0);
	this.instance_311.setTransform(136.55,21.3,0.4436,0.4437,3.9226,0,0,1.4,-42.1);

	this.instance_312 = new lib.ch1_lLeg_rcopy_2("synched",0);
	this.instance_312.setTransform(131.3,64,0.4435,0.4435,2.5497,0,0,0.7,-50.6);

	this.instance_313 = new lib.ch1_neckcopy_2("synched",0);
	this.instance_313.setTransform(148.2,-45.4,0.4448,0.4448,11.34,0,0,-1.4,7.3);

	this.instance_314 = new lib.ch1_lLeg_lcopy_2("synched",0);
	this.instance_314.setTransform(165,63.85,0.4434,0.4434,-4.2452,0,0,3.2,-50.2);

	this.instance_315 = new lib.ch1_hand_lcopy_2("synched",0);
	this.instance_315.setTransform(187.35,41.05,0.4443,0.4443,55.1339,0,0,-10,10.8);

	this.instance_316 = new lib.ch1_thumb_lcopy_2("synched",0);
	this.instance_316.setTransform(187,39.45,0.4443,0.4443,65.9242,0,0,-7.5,13.7);

	this.instance_317 = new lib.ch1_lArm_lcopy_2("synched",0);
	this.instance_317.setTransform(174.3,3.3,0.4445,0.4444,76.2014,0,0,-45.1,12.7);

	this.instance_318 = new lib.ch1_uArm_lcopy_2("synched",0);
	this.instance_318.setTransform(171.35,-28.4,0.4446,0.4446,85.4862,0,0,-33,13.8);

	this.instance_319 = new lib.ch1_lBodycopy_2("synched",0);
	this.instance_319.setTransform(145.9,3,0.4454,0.4454,1.7611,0,0,-3.9,-21.4);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_191 = function() {
		...
		function fl_ClickToGoToWebPage() {
			document.location.replace("http://127.0.0.1:8090/LessonChapter1_08.html");
		}
		
		this.prevBtn.addEventListener("click", fl_ClickToGoToWebPage_2);
		
		function fl_ClickToGoToWebPage_2() {
			document.location.replace("http://127.0.0.1:8090/LessonChapter1_06.html");
		}
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/LessonChapter1_07_atlas_1.png?1655309432746", id:"LessonChapter1_07_atlas_1"},
		{src:"sounds/beforewar2edit_07wav.mp3?1655309433325", id:"beforewar2edit_07wav"}
	],
	preloads: []
};
